    ...
    <section className="w-full overflow-hidden bg-white py-10">
      <div className="mx-auto w-full max-w-8xl px-4 md:px-6">
        <div className="mb-10 ">
          ...
          <h2 className="mt-3 font-heading text-3xl leading-[1.2] text-heading md:text-4xl lg:text-5x text-center">
            Moments of Peace{" "}
            <span className="text-primary">& Transformation</span>
          </h2>
          <p className="mt-4 font-body max-w-3xl mx-auto text-sm leading-relaxed text-foreground md:text-base md:leading-[1.8] text-center">
